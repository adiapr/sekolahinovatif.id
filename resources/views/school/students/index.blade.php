            ...
            <div class="p-6">
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3 text-sm">
                                            <div class="flex space-x-2">
                                                ...
                                                <form action="{{ route('school.students.destroy', $student) }}" 
                ...
                @else
                    <div class="text-center py-8">
                        ...
                        <p class="text-gray-500 text-lg">Belum ada siswa yang ditambahkan</p>
                        <p class="text-gray-400 text-sm">Mulai dengan menambah siswa pertama Anda</p>
                    </div>
                @endif
            </div>
        </div>
