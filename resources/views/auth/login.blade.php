<x-app-layout>
    ...
    <div class="min-h-screen flex items-center justify-center relative mt-20 bg-gradient-to-br from-gray-900 via-gray-800 to-black">
        <!-- Decorative Elements -->
        ...
        <div class="relative z-10 w-full max-w-6xl mx-4 grid md:grid-cols-2 gap-0 bg-white  shadow-2xl overflow-hidden">
            
            <!-- Left Side - Branding -->
            <div class="hidden md:flex flex-col justify-center items-center p-12 bg-gradient-to-br from-red-600 via-red-700 to-red-900 text-white relative overflow-hidden">
                <!-- Pattern Background -->
                ...
                <div class="relative z-10 text-center">
                    ...
                    <h1 class="text-4xl font-bold mb-4">
                        Sekolah <span class="text-gray-100">Inovatif</span>
                    </h1>
                    <p class="text-red-100 text-lg mb-8 font-light">
                        Platform Digitalisasi Sekolah Modern
                    </p>
                    ...
                    <div class="space-y-4 text-left max-w-sm mx-auto">
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                <h3 class="font-semibold text-white">Manajemen Terintegrasi</h3>
                                <p class="text-sm text-red-100 opacity-90">Kelola semua aspek sekolah dalam satu platform</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                <h3 class="font-semibold text-white">Akses Real-time</h3>
                                <p class="text-sm text-red-100 opacity-90">Monitor data dan aktivitas kapan saja, dimana saja</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-red-100 opacity-90">Data terenkripsi dengan standar keamanan tinggi</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="absolute bottom-4 left-0 right-0 text-center">
            <p class="text-sm text-gray-400">
                © {{ date('Y') }} Sekolah Inovatif. All rights reserved.
            </p>
        </div>
    </div>
